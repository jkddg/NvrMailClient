...
public class InitSDK {
    ...
    public static void init() {
        ...
        login_V40("10.118.192.18", (short) 8000, "10", "wanda2020");
    }
...
//                        strDllPath = System.getProperty("user.dir") + "\\lib\\HCNetSDK.dll";
                        ...
                        //Linux系统加载库路径
                        strDllPath = LibPathUtil.DLL_PATH + "libhcnetsdk.so";
                    }
        ...
        if (playControl == null) {
            synchronized (PlayCtrl.class) {
                ...
                try {
                    if (osSelect.isWindows()) {
                        //win系统加载库路径
                        strPlayPath = LibPathUtil.DLL_PATH + "PlayCtrl.dll";
                    } else if (osSelect.isLinux()) {
                        //Linux系统加载库路径
                        strPlayPath = LibPathUtil.DLL_PATH + "libPlayCtrl.so";
                    }
