...
import com.jkddg.nvrmailclient.service.capture.AlarmCaptureService;
...
public class AlarmProcess {
    ...
    @Autowired
    AlarmCaptureService alarmCaptureService;

    private List<Integer> filterAlarmChannel(HCNetSDK.NET_DVR_ALARMINFO_V30 struAlarmInfo) {
...
//                log.info("报警类型：" + struAlarmInfo.dwAlarmType);  // 3-移动侦测
                ...
                alarmCaptureService.alarmCapture(channel);
                break;
